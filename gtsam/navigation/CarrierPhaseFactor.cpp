...
CarrierPhaseDDFactor::CarrierPhaseDDFactor(
    ...
    const Key ambiguityBaseKey, const double ddCarrierPhase,
    ...
    : Base(model, receiverPositionKey, ambiguityKey, ambiguityBaseKey),
...
Vector CarrierPhaseDDFactor::evaluateError(
    ...
    const double& ambiguityBase, OptionalMatrixType HreceiverPos,
    OptionalMatrixType Hambiguity, OptionalMatrixType HambiguityBase) const {
