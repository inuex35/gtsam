...
// *************************************************************************
// CarrierPhaseDDFactor_REMOVED tests (Point3, no lever arm)
// *************************************************************************
TEST(TestCarrierPhaseDDFactor_REMOVED, ZeroError) {
  ...
  const auto factor = CarrierPhaseDDFactor_REMOVED(
...
// *************************************************************************
TEST(TestCarrierPhaseDDFactor_REMOVED, Jacobians) {
  const Point3 refPos(-3961908.12, 3348995.59, 3698211.13);
  const Point3 satPos(-5824269.46, -22935011.27, -12195522.22);
  const Point3 satPosBase(15524471.21, -16649826.68, -13512405.95);
...
// *************************************************************************
TEST(TestCarrierPhaseDDFactor_REMOVED, ConsistencyWithArm) {
  const Point3 refPos(-3961908.12, 3348995.59, 3698211.13);
  const Point3 satPos(-5824269.46, -22935011.27, -12195522.22);
  const Point3 satPosBase(15524471.21, -16649826.68, -13512405.95);
  const Point3 pos(-3961780.0, 3349050.0, 3698350.0);

  const auto factorPt = CarrierPhaseDDFactor_REMOVED(
      Key(0), Key(1), Key(2), 100.0, satPos, satPosBase, refPos);
...
// *************************************************************************
TEST(TestCarrierPhaseDDFactor_REMOVED, print) {
  const auto factor = CarrierPhaseDDFactor_REMOVED(
...
// *************************************************************************
TEST(TestCarrierPhaseDDFactor_REMOVED, equals) {
  const auto f1 = CarrierPhaseDDFactor_REMOVED(1,2,3, 100.0, Point3(1,2,3), Point3(4,5,6), Point3(7,8,9));
  const auto f2 = CarrierPhaseDDFactor_REMOVED(1,2,3, 100.0, Point3(1,2,3), Point3(4,5,6), Point3(7,8,9));
  const auto f3 = CarrierPhaseDDFactor_REMOVED(1,2,3, 200.0, Point3(1,2,3), Point3(4,5,6), Point3(7,8,9));
  CHECK(f1.equals(f2));
  CHECK(!f1.equals(f3));
}
